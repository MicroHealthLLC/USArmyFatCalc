...
public class FatCalActivity extends AppCompatActivity {
       ...
       // analysis(isfemale);
        ...
        history.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent is = new Intent(FatCalActivity.this, LogHistory.class);
                startActivity(is);
            }
        });
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(FatCalActivity.this, MainActivity.class);
                startActivity(i);
            }
        });
        about.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in = new Intent(FatCalActivity.this, About.class);
                startActivity(in);
            }
        });
     ...
     //If is female is true
        if(isfemale){
            ...
            if(((user_age >=17 && user_age <=27)&&(bodyfat>=0 && bodyfat <=26))|| ((user_age >=28 && user_age <=39)&&(bodyfat>=0 && bodyfat <=28))|| ((user_age >=40)&&(bodyfat>=0 && bodyfat <=30))){
                ...
                bf.setText("You do not meet the Department of Defense goal: "+Integer.valueOf(bodyfat.intValue()));
                bf.setTextColor(getResources().getColor(R.color.red));
                bar1 = (ColorArcProgressBar) findViewById(R.id.bar1);
                bar1.setMaxValues(Integer.valueOf(bodyfat.intValue()));
                bar1.setCurrentValues(Integer.valueOf(bodyfat.intValue()));
                bar1.setcolor1(getResources().getColor(R.color.yellow));
                bar1.setcolor2(getResources().getColor(R.color.yellow));
                bar1.setcolor3(getResources().getColor(R.color.red));
